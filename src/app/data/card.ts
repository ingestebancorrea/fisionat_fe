...
export const cards: Card[] = [
    ...
    },
    {
        ...
        content: 'Nuestra fisioterapia pediátrica está diseñada para apoyar el desarrollo físico y funcional de los niños. A través de terapias lúdicas y personalizadas, ayudamos a mejorar la movilidad, la fuerza y la coordinación, abordando condiciones específicas y fomentando un crecimiento saludable. ¡Contáctanos para más información!',
        icon: "smart_toy",
        route: ""
    }
];